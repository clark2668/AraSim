  ...
  //  cout << "TEST1" << endl;
    ...
    //                                       signal->TaperVmMHz( viewangle, event->Nu_Interaction[0].d_theta_em[l], event->Nu_Interaction[0].d_theta_had[l], event->Nu_Interaction[0].emfrac, event->Nu_Interaction[0].hadfrac, vmmhz1m_tmp, vmmhz1m_em);
					   ...
					   //cout << "Check 2" << endl;
                                       ...
                                       stations[i].strings[j].antennas[k].Pol_factorH.push_back(n_trg_slappy * Pol_vector);
                                       stations[i].strings[j].antennas[k].Pol_factorV.push_back(n_trg_pokey * Pol_vector);
					 ...
					 if (settings1->EVENT_TYPE==0){
						 ...
						 if (settings1->ANTENNA_MODE == 1){
					       ...
					       stations[i].strings[j].antennas[k].Pol_factor.push_back( Pol_factor );
					       stations[i].strings[j].antennas[k].Pol_factorH.push_back(abs(n_trg_slappy * Pol_vector));
					       stations[i].strings[j].antennas[k].Pol_factorV.push_back(abs(n_trg_pokey * Pol_vector));
